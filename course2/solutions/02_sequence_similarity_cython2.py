%%cython --annotate
## here, instead of typing python string as str,
## I convert them to unicode first, according to recommendation from cython docs : https://cython.readthedocs.io/en/latest/src/tutorial/strings.html
## this should let me pass them as C character array (char*) to my function, to make it purer C
